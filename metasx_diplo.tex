...
\begin{tikzpicture}[scale=0.8]
  ...
  \draw [in=110, out=70, looseness=0.75,blue!50,thin] (8.center) edge[-latex] 
  ...
  \draw [in=110, out=70, looseness=0.75,blue!50,thin] (18.center) edge[-latex] 
    node[blue!75,midway,above=10pt,xshift=5pt] {$u=r \cos{\theta}$} 
    node[blue!75,midway,above,xshift=5pt] {$v=r \sin{\theta}$} (23.center);
  \draw [in=-110, out=-70, looseness=0.75,blue!50,thin] (n1.center) edge[-latex] 
