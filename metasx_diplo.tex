...
\begin{tikzpicture}[scale=0.8]
  ...
  %shapes and fillings
  \draw[shading=axis,top color=blue!15,bottom color=blue!75,shading angle=75,opacity=0.5] (o3) rectangle (th-|r) ;
  \draw[Col1,very thick] (o3) rectangle (th-|r) ;
  \draw[shading=axis,top color=blue!15,bottom color=blue!75,shading angle=90,opacity=0.5] 
    (o1) ellipse (2 and 1);
  \draw[Col1,very thick] (o1) ellipse (2 and 1);
  \draw[shading=axis,top color=blue!15,bottom color=blue!75,shading angle=75,opacity=0.5] (o2) circle (1);
  ...
  \draw [in=150, out=30, looseness=0.75,blue!50,thin] (18.center) edge[-latex] 
    node[blue!75,midway,above=14pt,xshift=5pt] {$u=r \cos{\theta}$} 
    node[blue!75,midway,above=4pt,xshift=5pt] {$v=r \sin{\theta}$} (23.center);
