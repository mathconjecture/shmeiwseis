...
\item {}
  \begin{enumerate}
    ...
    \item συναρτήσεις $ f(x)=x^{3} $ και $ g(x)= \sin x $ είναι περιττές.
  \end{enumerate}
\end{examples}
...
\begin{rem}
  ...
  θεωρήσαμε ότι η σειρά~\eqref{eq:trigser} συγκλίνει ομοιόμορφα στην $f$. 
  Γεγονός είναι ότι για κάθε συνάρτηση $f$ που είναι ολοκληρώσιμη στο 
  $ [- \pi , \pi] $, μπορούμε να υπολογίσουμε τους συντελεστές Fourier
  και τυπικά να σχηματίσουμε τη σειρά 
  \[
    \frac{a_{0}}{2} + \sum_{n=1}^{\infty} [a_{n} \cos{nx} + b_{n} \sin{nx}]
  \] 
  που ονομάζεται σειρά Fourier της $f$. Υπό ποιες προϋποθέσεις η σειρά Fourier 
  μιας συνάρτησης $f$ συγκλίνει στην $f$, απαντάται στο επόμενο θεώρημα.
\end{rem}
...
\begin{rem}
  ...
  \[ 
    \frac{x}{t} = \frac{2L}{2 \pi} \Leftrightarrow x= \frac{L}{\pi} t
  \]
...
\subsection*{Συνημιτονική σειρά Fourier}

Αν η $f$ είναι \textbf{άρτια}, τότε η συνάρτηση $ f(x) \cos{(nx)} $ είναι επίσης 
\textbf{άρτια} (γινόμενο άρτιας με άρτια συνάρτηση είναι άρτια), ενώ η συνάρτηση 
$ f(x) \sin{(nx)} $ είναι \textbf{περιττή} 
(γινόμενο άρτιας με περιττή συνάρτηση είναι περιττή), για αυτό, αν λάβουμε υπόψιν 
...
\subsection*{Ημιτονική σειρά Fourier}

Αν η $f$ είναι \textbf{περιττή}, τότε η συνάρτηση $ f(x) \cos{(nx)} $ είναι επίσης 
\textbf{περιττή} (γινόμενο άρτιας με περιττή συνάρτηση είναι περιττή), ενώ η συνάρτηση 
$ f(x) \sin{(nx)} $ είναι \textbf{άρτια} 
(γινόμενο περιττής με περιττή συνάρτηση είναι άρτια), για αυτό, αν λάβουμε υπόψιν μας 
