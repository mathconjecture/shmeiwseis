...
\begin{rem}
  ...
  \] 
  που ονομάζεται σειρά Fourier της $f$. Το υπό ποιες προϋποθέσεις η σειρά Fourier 
  μιας συνάρτησης $f$ συγκλίνει στην $f$, απαντά το επόμενο θεώρημα.
\end{rem}
...
\subsection*{\ensuremath{f} άρτια}

Αν η $f$ είναι άρτια, τότε η συνάρτηση $ f(x) \cos{(nx)} $ είναι επίσης \textbf{άρτια} 
(γινόμενο άρτιας με άρτια συνάρτηση είναι άρτια), ενώ η συνάρτηση 
...
\subsection*{\ensuremath{f} περιττή}

Αν η $f$ είναι περιττή, τότε η συνάρτηση $ f(x) \cos{(nx)} $ είναι επίσης 
