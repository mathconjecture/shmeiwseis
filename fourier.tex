...
\[
  \frac{a_{0}}{2} + \sum_{n=1}^{\infty} a_{n} \cos{(nx)} \quad 
...
και τότε η σειρά Fourier της $f$ γίνεται:
\[
  \sum_{n=1}^{\infty} b_{n} \sin{(nx)} \quad \text{\color{Col1} Ημιτονική σειρά Fourier}
\]
...
και τότε η σειρά Fourier της $f$ γίνεται:
\[
  \frac{a_{0}}{2} + \sum_{n=1}^{\infty} a_{n} \cos{\left(\frac{n \pi x}{L}\right)} \quad 
  \text{\color{Col1} Συνημιτονική σειρά Fourier}
\]
...
και τότε η σειρά Fourier της $f$ γίνεται:
\[
  \sum_{n=1}^{\infty} b_{n} \sin{\left(\frac{n \pi x}{L}\right)} \quad 
