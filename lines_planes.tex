...
\begin{wrapfigure}{l}{0.28\linewidth}
  \begin{tikzpicture}[scale=0.7]
    ...
    \node  (2) at (-2, -1) {};
    \node  (3) at (3, 0) {};
    \node  (5) at (-0.75, 2) [pin={[pin edge={black,latex-},Col2]115:\smaller$t=0$}] {};
    \node  (6) at (3.5, 1) [pin={[pin edge={black,latex-},Col2]93:\smaller$t=1$}] {};
...
\begin{wrapfigure}{l}{0.34\linewidth}
  \begin{tikzpicture}[scale=0.7]
    ...
    \begin{pgfonlayer}{fg}
      ...
      \draw[ultra thick,-latex,Col1] (po.center) to (4,3.5) node[right] (n) 
        {$\mathbf{n}$};
    ...
    \draw[name path=plane,shading=ball,ball color=blue!75,opacity=0.4] (a) -- (b) -- 
      (c) -- (d) -- (a) ;
  ...
  \InsertBoxR{1}{\parbox[b][1.5\baselineskip][c]{0.33\textwidth}
    {\begin{tikzpicture}[scale=0.8]
        \begin{pgfonlayer}{bg}
          ...
          \fill (c) circle (1.5pt) ;
        \end{pgfonlayer}
        \draw[shading=ball,ball color=blue!75,opacity=0.5] (a) to (b) to (c) to (a) ;
        \draw[-latex] (a) to (x);
        \draw[-latex] (b) to (y);
        \draw[-latex] (c) to (z);
...
\InsertBoxR{0}{\parbox[b][3\baselineskip][c]{0.30\textwidth}
  {\begin{tikzpicture}[scale=0.8]
      ...
      \end{pgfonlayer}
      \begin{pgfonlayer}{bg}
        \path[shading=ball,ball color=Col1,opacity=0.4] (o.center) to (a.center) to 
          (b.center) to (intersection of b--c and a--d) to[every to={draw=red,dashed}] 
          (c.center) -- cycle   ;
      ...
      \begin{pgfonlayer}{fg}
        ...
        \draw (l) -- ++ (-.15,-.15) -- ++(.15,-.15) ;
      \end{pgfonlayer}
      \path[shading=ball,ball color=blue!75,opacity=0.5] (o.center) to (a.center) to 
        (d.center) to (e.center) -- cycle   ;
