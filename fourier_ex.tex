    ...
    \item 
      \begin{minipage}[t]{0.65\textwidth}
        \begin{myitemize}
          ...
          \item $f$ παραγωγίσιμη στο $ (0,2 \pi ) $ με $ f'(x)=1 $ και 
    ...
    \item 
      ...
      \begin{minipage}[t]{0.72\textwidth}
        \begin{myitemize}
          ...
          \item $f$ παραγωγίσιμη στο $ (-2,2) $ με $ f'(t)=2t $ και $ f'(-2^{+}) = -4 $ και 
      ...
      \[
        ...
        \frac{1}{2} \left[\frac{t^{3}}{3} \right]^{2}_{-2} = \frac{1}{2} \left(\frac{8}{3} -
        \frac{-8}{3}\right) = \frac{8}{3}
      \]
      \begin{align*}
        a_{n} &= \frac{2}{2} \int _{0}^{2} t^{2} \cos{\left( \frac{n \pi t}{2}\right)} 
        \,{dt} = \int _{0}^{2} t^{2} 
        \left(\frac{\sin{\left(\frac{n \pi t}{2}\right)}}{\frac{n \pi}{2}} \right)' \,{dt} = 
        \left[t^{2}\left(\frac{\sin{\left(\frac{n \pi t}{2}\right)}}{\frac{n \pi}{2}}
  ...
  \begin{enumerate}[i)]
    \item 
      ...
      \begin{minipage}[t]{0.65\textwidth}
        \begin{myitemize}
          \item $f$ συνεχής στο $ [-2,2] $ \hfill \tikzmark{a}
          \item $f$ παραγωγίσιμη στο $ (-2,2) $ με $ f'(t)=1 $ και $ f'(-2^{+}) = 
