...
\mythm{%
    ...
    \begin{enumerate}
        \item $ \lim\limits_{(x,y)\to (x_{0}, y_{0})} [f(x,y)\pm g(x,y)] = l_{1}\pm l_{2} $
        ...
        \item $ \lim\limits_{(x,y)\to (x_{0}, y_{0})} \frac{f(x,y)}{g(x,y)} = 
            \frac{l_{1}}{l_{2}}, \; l_{2} \neq 0 $
    \item $ \lim\limits_{(x,y)\to (x_{0}, y_{0})} [f(x,y)]^{a} = {l_{1}}^{a}, \; 
            a \in \mathbb{Q}^{*} $
        \item $ \lim\limits_{(x,y)\to (x_{0}, y_{0})} \abs{(x,y)} = \abs{l_{1}} $
    \end{enumerate}
}
