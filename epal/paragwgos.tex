...
Αν με $ y= f(x) $ συμβολίζουμε κάποια συνάρτηση, τότε για την παράγωγό της, 
...
\begin{exercise}
  Έστω $ y= \ln{\bigl(\sqrt{x^{2}+1}\bigr)} $. Να υπολογιστεί η παράγωγος της 
  συνάρτησης.  
\end{exercise}
\begin{solution}
  ...
  \twocolumnsiderrr{
    ...
    διαδοχικά προς τα <<έξω>>. Έτσι, θέτουμε $ u=x^{2}+1 $ και 
