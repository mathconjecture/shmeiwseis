...
\twocolumnsidess{
  ...
  \subsection*{Ιδιότητες διάταξης πραγματικών αριθμών} 
  \begin{myitemize}
...
\end{example}
\begin{rem}
  Η απόλυτη τιμή $ \abs{a} $, ενός αρίθμού, παριστάνει την \textbf{απόσταση} 
...
\subsection*{Άυξουσες - Φθίνουσες Συναρτήσεις}
...
\begin{rem}
  ...
  $y$}, ενώ, η γραφική παράστση μιας περιττής συνάρτησης είναι \textbf{συμμετρική ως 
  προς την άρχή των αξόνων}.
\end{rem}
