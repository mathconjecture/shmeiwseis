...
\begin{thmbreak}[\textlatin{\bfseries Bolzano}]
...
\begin{thmbreak}[\textlatin{\bfseries Rolle }]
...
\begin{thmbreak}[{\bfseries Θεώρημα Μέσης Τιμής \textlatin{Cauchy}}]
...
\begin{tikzpicture}[overlay, remember picture,decoration={brace,amplitude=4pt}]
	...
	\begin{thmbreak}[\textlatin{\bfseries Fermat}]
