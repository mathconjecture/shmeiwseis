...
\begin{description}
  ...
  \item[Ιδιότητα 9.] Ισχύουν οι παρακάτω σχέσεις.
    ...
    \twocolumnsides{
      \begin{enumerate}[i)]
        \item $ \abs{\mathbb{O}}=0, \quad $ όπου $\mathbb{O}$ ο μηδενικός πίνακας
        \item $\abs{\mathbb{I}}=1,\quad $ όπου $\mathbb{I}$ ο μοναδιαίος πίνακας
        \item $|A|=|A^T|$
      \end{enumerate}
      }{
      \begin{enumerate}[i)]
      ...
      \item $|A^{-1}|=\frac{1}{|A|}, \quad $ αν υπάρχει ο $ A^{-1} $
    \end{enumerate}
  }
\end{description}
\end{document}
